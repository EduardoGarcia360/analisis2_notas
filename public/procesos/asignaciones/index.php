...
<table class="table table-striped table-bordered">
    ...
    <?php while ($row = $result->fetch_assoc()) { ?>
        <tr>
            ...
            <td>
                <a href="edit.php?id=<?php echo $row['id_asignacion']; ?>" class="btn btn-warning btn-sm">Editar</a>
                <a href="javascript:void(0);" class="btn btn-danger btn-sm" onclick="confirmDelete(<?php echo $row['id_asignacion']; ?>)">Eliminar</a>
            </td>
        </tr>
    <?php } ?>
</table>
